...
const SliderButton = ({ className, dark, ...restProps }) => {
  return (
    <button
      className={`flex justify-center items-center bg-primary border-2 border-primary rounded-full h-8 w-8 transition-bg-color hover:text-primary focus:text-primary focus:outline-none ${
        dark
